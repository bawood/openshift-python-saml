...
RUN yum repolist > /dev/null && \
    ...
    INSTALL_PKGS="python python-devel python-setuptools python2-pip nss_wrapper httpd httpd-devel atlas-devel gcc-gfortran postgresql postgresql-devel sqlite xmlsec1 xmlsec1-openssl" && \
